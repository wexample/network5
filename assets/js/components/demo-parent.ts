...
import ComponentRenderDataInterface
    from "../../../src/Wex/BaseBundle/Resources/js/interfaces/ComponentRenderDataInterface";
...
const bundle: AssetBundleInterface = {
    ...
    definition: class extends Component {
        init(renderData: ComponentRenderDataInterface) {
            this.el.innerHTML =
                `<span class="success">✓</span>${this.el.innerHTML}`;
        }
    }
};
